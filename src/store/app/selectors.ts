...
export const getImagesSelector = createSelector(getImagesState, ({ images }) => images.data);
export const getImagesIsError = createSelector(getImagesState, ({ images }) => images.isError);
export const getImagesIsSuccess = createSelector(getImagesState, ({ images }) => images.isSuccess);
export const getImagesIsLoading = createSelector(getImagesState, ({ images }) => images.isLoading);
